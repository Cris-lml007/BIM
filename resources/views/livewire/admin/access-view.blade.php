<div>
    ...
    <livewire:table :heads="$heads" wire:model.live="actions" icon="fas fa-file text-primary" title="Accesos">
            ...
            <tr wire:key="{{ $item->id }}">
                ...
                <td>
                    ...
                    <button wire:click="changeStatus({{ $item->id }})" @class([
                        'btn btn-sm',
                        'btn-success' => $item->is_active,
                        'btn-secondary' => !$item->is_active,
                    ])>
                        <i @class([
                            'nf',
                            'nf-fa-toggle_on' => $item->is_active,
                            'nf-fa-toggle_off' => !$item->is_active,
                        ])></i>
                    </button>
